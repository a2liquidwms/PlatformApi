...
namespace PlatformApi.Migrations
{
    ...
    [Migration("20250804014220_IndexRoles")]
    partial class IndexRoles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PlatformApi.Models.Permission", b =>
                {
                    ...
                    b.Property<int>("ApplicableScopes")
                        .HasColumnType("integer")
                        .HasColumnName("applicable_scopes");
                    ...
                    b.Property<bool>("IsDefaultFlg")
                        .HasColumnType("boolean")
                        .HasColumnName("is_default_flg");
            ...
            modelBuilder.Entity("PlatformApi.Models.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d9b1d7aa-c58e-4a9f-9f8e-b25d7d707e44"),
                            CreateDate = new DateTime(2024, 11, 21, 0, 0, 0, 0, DateTimeKind.Utc),
